...
阶段 15a / 15b / 15c 的核心交付已在代码中落地。下一步主线切换到阶段 15 收口验收与运行说明补齐，方案见 [phases/phase15-security-productivity-skills.md](./phases/phase15-security-productivity-skills.md)。
...
1. 先执行根级 `npm run verify`，补一次阶段 15 的统一验收。
2. 收口部署文档与运行说明，补齐远程访问、浏览器自动化白名单、SMTP 配置与常见排障。
3. 再进入阶段 16 执行面硬化，重点是 OS 级沙箱与出站策略默认值。
