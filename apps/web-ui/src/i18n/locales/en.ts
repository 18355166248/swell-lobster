...
const en = {
  ...
  status: {
    ...
    auditTime: 'Time',
    auditOutput: 'Output',
    auditLoadFailed: 'Failed to load audit records',
    auditEmpty: 'No tool call records yet',
    auditDecisionSkipped: 'Skipped',
  ...
  extensions: {
    title: 'Extensions',
    subtitle: 'Unified management for builtin tools, skills and MCP servers',
    ...
    builtinNoToggle: 'Builtin tools cannot be disabled',
    searchPlaceholder: 'Search by name, id or description',
    empty: 'No extensions match the filter',
    totalSummary: 'Showing {{filtered}} / {{total}}',
    columnName: 'Name',
    columnSource: 'Source',
    columnHealth: 'Health',
