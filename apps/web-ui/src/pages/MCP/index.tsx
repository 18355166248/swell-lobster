...
export function MCPPage() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      <h1 className="text-2xl font-bold text-stone-800">MCP</h1>
      <p className="mt-1 text-stone-600 text-sm">MCP 服务器管理</p>
      {error && (
      ...
      <div className="mt-6 border border-stone-200 rounded overflow-hidden">
        {servers.length === 0 ? (
          <div className="px-4 py-8 text-stone-500 text-sm text-center">暂无 MCP 服务器配置</div>
        ) : (
