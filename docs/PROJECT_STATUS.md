...
## ✅ 已完成功能（阶段 1-7、阶段 9、阶段 10、阶段 11、阶段 12 已完成；阶段 13 后端基线已落地）
...
### 优先级3：阶段13收口——统一扩展前端入口与审计联动

- 补统一扩展列表页，展示来源、健康状态、权限画像与启停动作
- 执行审计日志补充扩展来源字段，支持按来源过滤
