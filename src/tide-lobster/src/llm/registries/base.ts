...
export function providerInfoToDict(p: ProviderInfo): Record<string, unknown> {
  ...
  if (p.coding_plan_base_url !== undefined)
    d.coding_plan_base_url = p.coding_plan_base_url;
  if (p.coding_plan_api_type !== undefined)
    d.coding_plan_api_type = p.coding_plan_api_type;
